...
fly ssh console -a finance-app-bitter-morning-9768 -C "tar -czf /tmp/data_backup.tar.gz /app/data" || {
...
fly ssh sftp -a finance-app-bitter-morning-9768 get /tmp/data_backup.tar.gz "./backups/backup_${BACKUP_DATE}.tar.gz" || {
